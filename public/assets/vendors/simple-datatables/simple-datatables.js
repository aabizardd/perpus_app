                ...
                function(require, module, exports) {
                    ...
                    const isObject = t =>
                        ...
                        truncate = (t, e, s, a, i) => {
                            ...
                            return (
                                o.forEach(e => {
                                    const s = e.children[0].getAttribute(
                                        "data-page"
                                    );
                                    if (n) {
                                        const e = n.children[0].getAttribute(
                                            "data-page"
                                        );
                                        if (s - e == 2) d.push(t[e]);
                                        else if (s - e != 1) {
                    ...
                    class DataTable {
                        ...
                        render(t) {
                            ...
                            a.appendChild(i),
                                ...
                                (this.label = this.wrapper.querySelector(
                                    ".dataTable-info"
                                )),
                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        this.table.replaceChild(e, s),
                                            ...
                                            (this.headerTable.parentElement.style.paddingRight = `${this
                                                .headerTable.clientWidth -
